...
Returning to [dragonview](Locations\Dragonview), we find that [Sarkas](NPC's\Sarkas) has left for one of the major cities. We also discuss our avenging of [Aldritch's](NPC's\Aldritch). Moving on to look for **Sarkas**, we travel to [Ouromael](Locations\Ouromael), only to find Lilith's adoptive parents are missing.
</details>

# [Session 5 notes](Session-5-notes.md)
<details><summary style="font-size: 20px; font-weight: bold">Summary</summary>
